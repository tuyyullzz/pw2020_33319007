...
<body style="background-color: #AB47BC;">
  ...
  <div style="height:100px;width: 500px;text-align: center;position:center;margin-left:450px;margin-top:50px;" align="center">
    <form class="text-center border border-light p-5" action="#!" style="background-color: white;box-shadow: 0 5px 15px rgba(0,0,0,.5);">
      ...
      <!-- Nama -->
      <input type="text" class="form-control mb-4" placeholder="Nama" name="nama" autocomplete="off" required value="<?= $m['nama']; ?>" readonly>

      <!-- NIM -->
      <input type="text" class="form-control mb-4" placeholder="NIM" name="nim" autocomplete="off" required value="<?= $m['nim']; ?>" readonly>
      <!-- NIM -->
      <input type="text" class="form-control mb-4" placeholder="Jurusan" name="jurusan" autocomplete="off" required value="<?= $m['jurusan']; ?>" readonly>
      <!-- NIM -->
      <input type="text" class="form-control mb-4" placeholder="Kelas" name="kelas" autocomplete="off" required value="<?= $m['kelas']; ?>" readonly>
      <!-- NIM -->
      <input type="text" class="form-control mb-4" placeholder="Gambar" name="gambar" autocomplete="off" required value="<?= $m['gambar']; ?>" readonly>
